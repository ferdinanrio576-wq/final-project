...
class ProductListView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        # Pass filters back to keep form state
        ...
        # Featured & New Arrivals for home page layout / banner widgets
...
class ProductDetailView(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        service = ProductService()
        context['related_products'] = service.get_related_products(product)
        context['specifications'] = product.specifications.all()
        context['images'] = product.images.all()
        context['reviews'] = product.reviews.all().select_related('user').order_by('-created_at')
